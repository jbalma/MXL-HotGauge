...
~/HotGauge/snipersim/output/mod_linpack 7 8
\end{lstlisting}

The two numbers that proceed the path to sniper output root are the number of cores being simulated and the maximum number of jobs that the scripts are allowed to have running at any given time.
...
core-name cores_2_6 --num-threads 8 --grid-args "--heatmap_width 80.0" --grid-args "-- \
