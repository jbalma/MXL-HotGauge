...
air.translate(App.Vector(- chip_width / 2 - (box_width - base_width) / 2, chip_height + base_height, - chip_depth - (box_depth - base_depth) / 2))
...
obj = doc.addObject("Part::Feature", "Water")
obj.Shape = air
